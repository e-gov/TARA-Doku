...
- _pääsutõend_, (_access token_), Riigi autentimisteenuse poolt rakendusele väljastatav allkirjastatud teave
...
- _volituskood_, (_authorization code_), juhuarv, mille esitamisel rakendus saab autentimisteenuselt identsustõendi ja pääsutõendi.
